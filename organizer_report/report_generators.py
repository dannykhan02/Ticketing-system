...
class PDFReportGenerator:
    ...
    def generate_pdf(self, report_data: Dict[str, Any], chart_paths: List[str], output_path: str, session: Session, event_id: int) -> Optional[str]:
        try:
            processed_data = ReportDataProcessor.process_report_data(report_data, session, event_id)
