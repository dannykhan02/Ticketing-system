...
Revision ID: 6fd2343460a2
Revises: 
Create Date: 2025-03-20 14:26:04.795079
...
def upgrade():
    ...
    sa.Column('payment_status', sa.Enum('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED', 'CANCELED', 'CHARGEBACK', 'ON_HOLD', name='paymentstatus'), nullable=False),
