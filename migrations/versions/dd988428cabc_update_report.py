...
Revision ID: dd988428cabc
Revises: 306f621a87bb
Create Date: 2025-05-25 23:21:39.487637
...
revision = 'dd988428cabc'
down_revision = '306f621a87bb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('reports', schema=None) as batch_op:
        batch_op.drop_index('ix_reports_event_id')
        batch_op.drop_index('ix_reports_ticket_type_id')
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['event_id'], ['event.id'], name='reports_event_id_fkey'),
    sa.ForeignKeyConstraint(['ticket_type_id'], ['ticket_type.id'], name='reports_ticket_type_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='reports_pkey')
    )
    with op.batch_alter_table('reports', schema=None) as batch_op:
        batch_op.create_index('ix_reports_ticket_type_id', ['ticket_type_id'], unique=False)
        batch_op.create_index('ix_reports_event_id', ['event_id'], unique=False)
